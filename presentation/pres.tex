...
\begin{frame}{Dragonfly? What's that?}
    \begin{columns}[T]
        \begin{column}{.5\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=.65\textwidth]{images/dragonfly_python.png}
                \caption{What we have.}
            \end{figure}
        \end{column}
        \begin{column}{.5\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=.9\textwidth]{images/dragonfly_python.png}
                \caption{What we want.}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}{Results 1}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=.9\textwidth]{images/total_time.png}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=.9\textwidth]{images/actions_per_minutes.png}
...
\begin{frame}{Results 2}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=.9\textwidth]{images/total_actions.png}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=.9\textwidth]{images/legal_actions.png}
...
\begin{frame}{Results 3}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=.9\textwidth]{images/hand_error_rate.png}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=.9\textwidth]{images/speech_error_rate.png}
